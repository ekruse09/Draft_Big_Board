...
class Player:
    def __init__(self, name, college, height, weight, birth_date):
        self.name = name
...
class QB(Player):
    def __init__(self, name, college, height, weight, birth_date, arm_strength=Grade.C, ball_placement=Grade.C,
                 field_processing=Grade.C, pocket_presence=Grade.C, scrambling=Grade.C):
        super().__init__(name, college, height, weight, birth_date)
...
class RB(Player):
    def __init__(self, name, college, height, weight, birth_date, acceleration=Grade.C, contact_balance=Grade.C,
...
class WR(Player):
    def __init__(self, name, college, height, weight, birth_date, ball_carrier_ability=Grade.C, catching=Grade.C,
...
class OT(Player):
    def __init__(self, name, college, height, weight, birth_date, awareness=Grade.C, movement_skills=Grade.C,
...
class IDL(Player):
    def __init__(self, name, college, height, weight, birth_date, awareness=Grade.C, block_shedding=Grade.C,
...
class Edge(Player):
    def __init__(self, name, college, height, weight, birth_date, awareness=Grade.C, coverage_ability=Grade.C,
                 movement_skills=Grade.C, pass_rushing=Grade.C, run_stuffing=Grade.C):
        super().__init__(name, college, height, weight, birth_date)
        self.awareness = awareness
...
class CB(Player):
    def __init__(self, name, college, height, weight, birth_date, awareness=Grade.C, man_coverage=Grade.C,
